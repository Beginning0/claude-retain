# Wrapper PowerShell para mostrar estadísticas de memoria persistente y cache LLM
...
$args = if ($args.Count -gt 0) { $args } else { @("stats") }
$PYTHONPATH = $PYTHONPATH; & $pythonExe -c "import sys; sys.path.insert(0, r'$pluginDir'); from claude_retain.cli import main; main()" stats @args
